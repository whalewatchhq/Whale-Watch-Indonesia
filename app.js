...
function WhaleWatchApp() {
  ...
  const loadArticles = async () => {
    try {
      // Pastikan nama kolom 'title' atau 'tittle' sesuai dengan Supabase Anda
  ...
  useEffect(() => {
    if (articles.length > 0) {
      ...
      if (hash.startsWith("#article/")) {
        ...
        // Cari artikel berdasarkan ID dari hash
          ...
          <div className="space-y-4">
            {topNews.map((t) => (
              <div
                ...
                onClick={() => handleViewArticle(t)} // MENGGUNAKAN FUNGSI BARU
              >
                <img
                  src={t.thumbnail}
        ...
        {filteredArticles.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredArticles.map((a) => (
              <div
                key={a.id}
                onClick={() => handleViewArticle(a)} // MENGGUNAKAN FUNGSI BARU
